/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 56690540bd0dcfb948f2b0c0b9950fd6)
// Runtime types generated with workerd@1.20260811.1 2026-08-13 nodejs_compat
interface __BaseEnv_Env {
	ROOM_CREATE_RATE_LIMITER: RateLimit;
	ROOM_ACTION_RATE_LIMITER: RateLimit;
	ANALYTICS_RATE_LIMITER: RateLimit;
	FRONTEND_ORIGIN: "https://30segundos.vercel.app";
	ROOMS: DurableObjectNamespace<import("./cloudflare/worker").RoomDurableObject>;
	ANALYTICS: DurableObjectNamespace<import("./cloudflare/worker").AnalyticsDurableObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/worker");
		durableNamespaces: "RoomDurableObject" | "AnalyticsDurableObject";
	}
